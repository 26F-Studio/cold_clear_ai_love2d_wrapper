...
$(MY_COLDCLEAR_LOCAL_PATH)/$(CCNAME).c:
	...
	cd $(MY_COLDCLEAR_LOCAL_PATH)/cold-clear && cargo ndk -t $(TARGET_ARCH_ABI) --platform 24 build -p c-api --release
	cp $(MY_COLDCLEAR_LOCAL_PATH)/cold-clear/target/*/release/libcold_clear.a $(MY_COLDCLEAR_LOCAL_PATH)/lib$(CCNAME).a
	cd $(MY_COLDCLEAR_LOCAL_PATH)/cold-clear && cargo clean
	touch $@
